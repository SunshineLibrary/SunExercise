...
public class GetData {
    ...
    public GetData() {
        resolver = ExerciseApplication.getAppContext().getContentResolver();
    }
    ...
    private JsonObject getActivityDetail(int activity_id) {
        Cursor cursor = resolver.query(MetadataContract.Activities.getActivityUri(activity_id), null , MetadataContract.Activities._IDENTIFIER + " + " + activity_id, null, null);
        cursor.moveToFirst();
